    ...
    <div className=" bg-gradient-to-bl from-violet-700 via-black to-indigo-800 h-screen w-screen flex justify-center items-center">
      <div>
        <div className="flex justify-center items-center flex-col ">
          <div className="relative w-[120px] h-[120px] overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600 border-gray-400 border-2">
            <Image
              width={500}
              height={500}
              alt="a"
          ...
          <p className="text-white pt-1 text-lg">@bataa</p>
          {/* <input
          ...
          <div className="pt-[40px] flex flex-col gap-[13px]">
            <button className="backdrop-blur-sm bg-white/20 backdrop-opacity-60 text-white font-semibold py-2 px-4 border border-gray-400 w-screen sm:w-[30rem] h-[3rem] rounded-md">
              Button
            </button>
            <button className="backdrop-blur-sm bg-white/20 backdrop-opacity-60 text-white font-semibold py-2 px-4 border border-gray-400 w-screen sm:w-[30rem] h-[3rem] rounded-md">
              Button
          ...
          <div className="flex gap-2 mt-[45px]">
            <a href="https://github.com/TengisLIONBOX" target="_blank">
              <GithubIcon />
            </a>
            <a href="https://github.com/TengisLIONBOX" target="_blank">
              <InstaIcon />
            </a>
            <a href="https://youtube.com/LIONBOX" target="_blank">
              <YtIcon />
            </a>
            <a
          ...
          <p className="text-white mt-[50px]">© All rights reserved 2023</p>
        </div>
      </div>
    </div>
  );
